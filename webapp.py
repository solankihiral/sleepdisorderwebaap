...
if not os.path.exists(file_path):
    ...
    def initialize_session_state():
        ...
        if 'Sleep Duration' not in st.session_state:
            st.session_state['Sleep Duration'] = 1
            ...
            if re.fullmatch(regex, Email):
                ...
                if Email == 'a@a.com' and Password == '123':
                    ...
                    if result:
                        ...
                        if 'Sleep Duration' not in st.session_state:
                            st.session_state['Sleep Duration'] = 2  # Default age
                        SD = st.number_input("Sleep Duration", 1, 20, value=st.session_state["Sleep Duration"], key="Sleep Duration")
